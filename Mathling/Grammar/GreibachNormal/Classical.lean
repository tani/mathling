...
/-- Convert an arbitrary context-free grammar to Greibach normal form, choosing
classical orders.  Use `ContextFreeGrammar.toGreibachNormalGrammar` when executable
code is required. -/
