...
# Mathling / Grammar / NormalForms / GreibachClassical モジュール
...
public noncomputable def toGreibachNormalGrammar {T : Type}
...
```lean
@[important, grind =, simp] public theorem toGreibachNormalGrammar_language {T : Type}
